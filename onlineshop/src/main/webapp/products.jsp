                        ...
                        <div class="col-md-3 product-men">
                            <div class="men-pro-item simpleCart_shelfItem">
                                <div class="men-thumb-item">
                                    ...
                                    <img src="images"/<%=retriveProduct.getString("image")%>" alt="" class="pro-image-front">
                                    <img src="images"/<%=retriveProduct.getString("image")%>" alt="" class="pro-image-back"> <span class="product-new-top">New</span>
                                </div>
