        ...
        <div id="visual">
            <div class="slide-visual">
                <ul class="slide-group">
                    <li><img class="img-responsive" src="images/image4.jpeg" alt="Dummy Image1" /></li>
                    <li><img class="img-responsive" src="images/image5.jpeg" alt="Dummy Image2" /></li>
                    <li><img class="img-responsive" src="images/image6.jpeg" alt="Dummy Image3" /></li>
                </ul>
                <div class="script-wrap">
                    <ul class="script-group">
                        <li><div class="inner-script">
                                <img class="img-responsive" src="images/image4.jpeg" alt="Dummwy Image" />
                            </div></li>
                        <li><div class="inner-script">
                                <img class="img-responsive" src="images/image5.jpeg" alt="Dumeemy Image" />
                            </div></li>
                        <li><div class="inner-script">
                                <img class="img-responsive" src="images/image6.jpeg" alt="Dum33my Image" />
                            </div></li>
                    </ul>
                        ...
                        <div class="men-pro-item simpleCart_shelfItem">
                            <div class="men-thumb-item">
                                <input type="hidden" name="productId"
                                       ...
                                       src="<%=retriveProduct.getString("image")%>"
